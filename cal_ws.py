...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_gt', type=str, default='datasets/val_set14/Set14', help='Path to gt (Ground-Truth)')
    parser.add_argument('--src_sr', type=str, default='results/Set14', help='Path to restored images')
    ...
    # pdb.set_trace()
    cal_ws_metrics(parser.parse_args().src_gt, parser.parse_args().src_sr)
