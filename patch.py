...
def main():
    ...
    """
    root_path = '/hpc/data/home/bme/zhangzb1/Kaggle/HAT/dataset/train/'
    opt = {}
    opt['n_thread'] = 64
    opt['compression_level'] = 3

    # opt['input_folder'] = root_path + 'HR'
    # opt['save_folder'] = root_path + 'HR_sub_512'
    # opt['wh'] = (2048, 1024)
    # opt['scale'] = 1
    # opt['crop_size'] = 512
    # opt['step'] = 256
    ...
    opt['input_folder'] = root_path + 'LR/X4'
    opt['save_folder'] = root_path + 'LR/X4_sub64'
    opt['scale'] = 4
    opt['wh'] = (512, 256)
    opt['crop_size'] = 64
    opt['step'] = 32
...
# for f in gb.glob('/hpc/data/home/bme/zhangzb1/Kaggle/HAT/dataset/train/LR/X4_sub_64/*'):
#     os.remove(f)
#     print(f)